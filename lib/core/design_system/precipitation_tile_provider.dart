...
class PrecipitationTileProvider extends TileProvider {
  final String apiKey;
  final String baseUrl =
      'https://tile.openweathermap.org/map/precipitation_new';

  PrecipitationTileProvider({required this.apiKey});

  @override
  ImageProvider getImage(TileCoordinates coordinates, TileLayer options) {
    return _PrecipitationTileImage(
...
class _PrecipitationTileImage extends ImageProvider<_PrecipitationTileImage> {
  final TileCoordinates coordinates;
  final TileLayer options;
  final String apiKey;
  final String baseUrl;

  _PrecipitationTileImage({
  ...
  ImageStreamCompleter loadImage(
      _PrecipitationTileImage key, ImageDecoderCallback decode) {
  ...
  Future<ui.Codec> _loadAsync(_PrecipitationTileImage key) async {
  ...
  @override
  Future<_PrecipitationTileImage> obtainKey(ImageConfiguration configuration) {
  ...
  bool operator ==(Object other) {
    ...
    return other is _PrecipitationTileImage &&
